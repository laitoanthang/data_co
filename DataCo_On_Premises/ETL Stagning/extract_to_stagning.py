...
import pandas as pd 
import pyodbc
sys.path.append(r'C:\Users\Admin\OneDrive - VNU-HCMUS\_AI23\Sharepoint\DataCo_On_Premises')

# read dataframe
orders = pd.read_csv(r"C:\Users\Admin\OneDrive - VNU-HCMUS\_AI23\Sharepoint\DataCo_On_Premises\ETL Stagning\data\DataCoSupplyChainDataset.csv" , encoding='latin-1')
...
# #create connection
# conn, cursor = cf.create_connection(server='localhost, 1434' , username='sa' , password='Laitoanthang219!' , database='DB_staging')
# print('successful')
